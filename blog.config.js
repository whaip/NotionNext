...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'LWanR', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '熊教教主🐻', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.xiongjiao-jiaozhu.love', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '教主, 博客', // 网站关键词 英文逗号隔开
